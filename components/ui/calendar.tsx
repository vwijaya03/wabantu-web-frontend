    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "pointer-events-auto absolute left-0 top-0 z-10 h-[--cell-size] w-[--cell-size] select-none p-0 aria-disabled:opacity-50",
          defaultClassNames.button_previous,
        ),
        button_next: cn(
          buttonVariants({ variant: buttonVariant }),
          "pointer-events-auto absolute right-0 top-0 z-10 h-[--cell-size] w-[--cell-size] select-none p-0 aria-disabled:opacity-50",
        ...
        day: cn(
          ...
          "[&_button]:h-[--cell-size] [&_button]:w-[--cell-size]",
          defaultClassNames.day,
        ),
